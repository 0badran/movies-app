...
function Movies() {
  ...
  function checkOnFavorite(heartEle, movie) {
    ...
    if (emptyHeartIcon === "bi-heart") {
      ...
      heartEle.className = heartEle.className.replace(
        emptyHeartIcon,
  ...
  return movies.length ? (
    <>
      <Row>
        {movies.map((movie) => {
          let setClass =
            "bi bi-heart text-light me-4 mt-3 position-absolute end-0";
          favoriteMoviesId.find((id) => {
            if (id === movie.id) {
              setClass =
                "bi bi-heart-fill text-danger me-4 mt-3 position-absolute end-0";
            }
          });
          return (
            <Col
              ...
              >
                <Card className="shadow text-bg-dark h-100">
                  ...
                  >
                    ...
                    <Card.Title className="text-ellipses">
                      {movie.title}
                    </Card.Title>
